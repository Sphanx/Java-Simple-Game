...
public class ForestScreenController implements Initializable {
    ...
    @FXML
    ImageView character, endImg, leaveImg, enemyImg, enemyDiceImg, playerDiceImg;
    ...
    public void Battle(){
        ...
        playerDice.setText(String.valueOf(forest.playerAttack()));
        enemyDice.setText(String.valueOf(forest.enemyAttack()));
        updateEnemyStatus();
        if(forest.isEnemyDead()){
            win();
        }
        //Enemy Turn
        updatePlayerStatus();
        if(forest.isPlayerDead()){
            lose();
        }
    }
    ...
    public void updatePlayerStatus(){
        hpLbl.setText("Can: " + forest.getTotalHealth());
        dmgLbl.setText("Hasar zarı: 1d" + player.getTotalDamage());
        coinLbl.setText("Para: " + player.getCoin());
    }

    public void updateEnemyStatus(){
        hpLbl1.setText("Can: " + forest.getEnemy().getHealth());
        dmgLbl1.setText("Hasar zarı: 1d" + forest.getEnemy().getDamage());
        coinLbl1.setText("Ödül: " + forest.getEnemy().getCoin());
    }
