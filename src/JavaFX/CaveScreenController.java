...
public class CaveScreenController implements Initializable {
    ...
    public void Battle(){
        ...
        playerDice.setText(String.valueOf(cave.playerAttack()));
        enemyDice.setText(String.valueOf(cave.enemyAttack()));
        updateEnemyStatus();
        if(cave.isEnemyDead()){
            win();
        }
    ...
    public void updatePlayerStatus(){
        hpLbl.setText("Can: " + cave.getTotalHealth());
        dmgLbl.setText("Hasar zarı: 1d" + player.getTotalDamage());
        coinLbl.setText("Para: " + player.getCoin());
    }

    public void updateEnemyStatus(){
        hpLbl1.setText("Can: " + cave.getEnemy().getHealth());
        dmgLbl1.setText("Hasar zarı: 1d" + cave.getEnemy().getDamage());
        coinLbl1.setText("Ödül: " + cave.getEnemy().getCoin());
    }
